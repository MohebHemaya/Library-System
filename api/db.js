// In-memory database for Vercel (simulates JSON Server)
// Note: Data will reset on each deployment/restart, for persistence use a real database
...
export default function handler(req, res) {
  ...
  switch (req.method) {
    ...
    case 'PUT': {
      ...
      database[resource][index] = { ...database[resource][index], ...req.body };
      res.json(database[resource][index]);
      break;
    }
