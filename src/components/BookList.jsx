    ...
    axios
      ...
      .then((response) => {
        ...
        const uniqueCategories = [
          ...new Set(
            booksWithDefaults.map((book) => book.category || "Uncategorized"),
          ),
        ].sort();
        ...
        const totalCopies = booksWithDefaults.reduce(
          (sum, book) => sum + book.totalCopies,
          0,
        );
        const availableCopies = booksWithDefaults.reduce(
          (sum, book) => sum + book.availableCopies,
          0,
        );
        const lentCopies = totalCopies - availableCopies;
        const totalDebtCost = booksWithDefaults.reduce(
          (sum, book) => sum + book.debtCost * book.totalCopies,
          0,
        );
    ...
    axios
      ...
      .then((response) => {
        ...
        setBookStats({
          ...
          lent: bookStats.lent,
          totalDebtCost:
            bookStats.totalDebtCost +
            response.data.debtCost * response.data.totalCopies,
  ...
  const handleDeleteBook = (id) => {
    if (window.confirm("Are you sure you want to delete this book?")) {
      ...
      if (bookToDelete.availableCopies < bookToDelete.totalCopies) {
        alert(
          "Cannot delete this book because some copies are currently lent out.",
        );
        return;
      }
      ...
      axios
        ...
        .then(() => {
          ...
          setBookStats({
            ...
            totalDebtCost:
              bookStats.totalDebtCost -
              bookToDelete.debtCost * bookToDelete.totalCopies,
            totalTitles: bookStats.totalTitles - 1,
          });
      ...
      <div className="row mb-3">
        ...
        <div className="col-lg-4 col-md-12 text-md-end text-center">
          <div className="btn-group mb-2 w-100 w-md-auto">
            ...
            >
              <i
                className={`fas ${showAddBookForm ? "fa-minus" : "fa-plus"} me-1`}
              ></i>
        ...
        <div className="card mb-4 animate-slideIn">
          ...
          <div className="card-body">
            <div className="row row-tablet-adjust g-3">
              ...
              <div className="col-lg-6 col-md-6 col-sm-12">
                <label htmlFor="bookAuthors" className="form-label">
            ...
            <div className="row row-tablet-adjust g-3 mt-1">
              ...
              <div className="col-lg-4 col-md-4 col-sm-6">
                <label htmlFor="bookDebtCost" className="form-label">
                  Debt Cost (EGP)
                </label>
                <div className="input-group">
              ...
              <div className="col-lg-4 col-md-4 col-sm-6">
                <label htmlFor="bookCopies" className="form-label">
                  Number of Copies
                </label>
                <input
                  type="number"
              ...
              <tbody>
                {displayedBooks.map((book) => (
                  <tr
                    key={book.id}
                    className={
                      book.availableCopies === 0 ? "table-warning" : ""
                    }
                  >
                    <td>
