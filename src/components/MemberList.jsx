...
const MemberList = () => {
  ...
  const handleAddMember = () => {
    ...
    axios
      .post('http://localhost:8000/members', memberToAdd)
      .then((response) => {
        const updatedMembers = [...members, response.data];
        setMembers(updatedMembers);
        setFilteredMembers(updatedMembers);
        setNewMember({ name: '', debt: 0, maxDebt: SYSTEM_MAX_DEBT_LIMIT, email: '', phone: '' });
  ...
  const handleDeleteMember = (id) => {
    ...
    if (member.debt > 0) {
      alert(`Cannot delete a member with outstanding debt of EGP ${member.debt}`);
      return;
    }
    ...
    <div className="member-list-container">
      ...
      <div className="row mb-4">
        <div className="col-lg-8 col-md-7 col-sm-12 mb-3 mb-md-0">
          {/* Search Form */}
          <form onSubmit={handleSearch} className="mb-2 mb-md-4 search-form-mobile">
        ...
        <div className="col-lg-4 col-md-5 col-sm-12 text-md-end text-center">
          ...
          >
            <i className={`fas ${showAddMemberForm ? 'fa-minus' : 'fa-plus'} me-1`}></i>
          ...
          <div className="card-body">
            <div className="row row-tablet-adjust">
              <div className="col-lg-6 col-md-6 col-sm-12 mb-3">
                <label htmlFor="memberName" className="form-label">Member Name <span className="text-danger">*</span></label>
                <input
                  type="text"
                  className="form-control"
                  id="memberName"
                  ...
                  required
                />
                <div className="form-text">New members start with zero debt. Debt increases when books are borrowed.</div>
              </div>
              <div className="col-lg-6 col-md-6 col-sm-12 mb-3">
                <label htmlFor="maxDebtLimit" className="form-label">Maximum Debt Limit</label>
                <div className="input-group">
                ...
                <div className="form-text">Maximum system-wide limit is EGP {SYSTEM_MAX_DEBT_LIMIT}</div>
                ...
                <div className="mt-2">
                  <div className="progress" style={{ height: "8px" }}>
                    <div 
                      ...
                      role="progressbar" 
                      style={{ width: `${(newMember.maxDebt / SYSTEM_MAX_DEBT_LIMIT) * 100}%` }}
            ...
            <div className="row row-tablet-adjust">
              <div className="col-lg-6 col-md-6 col-sm-12 mb-3">
                ...
                <div className="form-text">Used for notifications and communications</div>
              </div>
              <div className="col-lg-6 col-md-6 col-sm-12 mb-3">
                <label htmlFor="memberPhone" className="form-label">Phone Number</label>
                <div className="input-group">
      ...
      {isLoading ? (
        ...
        <div className="alert alert-info animate-fadeIn">
          ...
          No members found. {searchTerm && <span>Try a different search term or <button className="btn btn-link p-0" onClick={() => {setSearchTerm(''); setFilteredMembers(members);}}>clear the search</button>.</span>}
        </div>
      ) : (
        <>
          {/* Desktop Table View */}
            ...
            <table className="table table-striped table-hover">
              ...
              <tbody>
                {displayedMembers.map((member) => (
                  <tr key={member.id} className={member.debt > 0 ? "table-warning" : ""}>
                    <td>{member.id}</td>
                    <td>
                    ...
                    <td>
                      {member.email ? (
                        ...
                        <span className="text-muted"><i className="fas fa-envelope me-1"></i> Not provided</span>
                      )}
                    </td>
                    <td>
                      {member.phone ? (
                        ...
                        <span className="text-muted"><i className="fas fa-phone me-1"></i> Not provided</span>
                      )}
                    </td>
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="progress flex-grow-1" style={{ height: "8px" }}>
                          <div 
                            ...
                            role="progressbar" 
                            style={{ width: `${getDebtPercentage(member.debt, member.maxDebt)}%` }}
                    ...
                    <td>
                      <span className={`badge ${getDebtStatusClass(member.debt, member.maxDebt)}`}>
                        {member.debt === 0 ? 'No Debt' : 
                         getDebtPercentage(member.debt, member.maxDebt) >= 80 ? 'High Debt' : 
                         getDebtPercentage(member.debt, member.maxDebt) >= 50 ? 'Medium Debt' : 'Low Debt'}
                      </span>
                    </td>
                    ...
                    <td>
                      <button 
                        ...
                        title={member.debt > 0 ? "Cannot delete a member with outstanding debt" : "Delete this member"}
                      >
      ...
      {!isLoading && filteredMembers.length > 0 && (
        <div className="card mt-4 animate-fadeIn" style={{animationDelay: "0.3s"}}>
          <div className="card-header">
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-md-6 col-lg-3 mb-3">
                <div className="card bg-light h-100">
                  <div className="card-body text-center py-3">
                    <h3 className="animate-pulse">EGP {filteredMembers.reduce((sum, member) => sum + parseInt(member.debt || 0), 0)}</h3>
              ...
              <div className="col-md-6 col-lg-3 mb-3">
                <div className="card bg-light h-100">
                  <div className="card-body text-center py-3">
                    <h3>{filteredMembers.filter(member => member.debt > 0).length}</h3>
